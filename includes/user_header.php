        ...
        <?php if($isLoggedIn): ?>
          <div class="relative group">
            ...
            <div class="user-dropdown absolute right-0 mt-2 w-48 hidden group-hover:block">
              ...
              <a href="my_orders.php" class="block px-4 py-3 text-gray-700 hover:bg-gray-50 hover:text-farm-green-700 transition-colors">
    ...
    <div class="px-4 pt-4 pb-6 space-y-2">
      ...
      <div class="pt-4 border-t border-gray-200">
        <?php if($isLoggedIn): ?>
          ...
          <a href="my_orders.php" class="mobile-menu-item block px-4 py-3 text-gray-700 font-medium">
